...
(function() {
  ...
  const DICTIONARY = {
    "Synergy Sugar ERP Setup": "Mipangilio ya Synergy Sugar ERP",
    "Configure your mill workspace or let AI guide you": "Sanidi nafasi ya kazi ya kiwanda chako au ruhusu AI ikuongoze",
    "Mill Profile": "Hali ya Kiwanda",
    "AI & Specs": "AI na Mapendeleo",
    "Finalize": "Kamilisha",
    "Mill & Enterprise Profile": "Hali ya Kiwanda na Biashara",
    "Mill / Enterprise Name *": "Jina la Kiwanda / Biashara *",
    "Primary Contact Person *": "Mtu Mkuu wa Mawasiliano *",
    "Business Email *": "Barua Pepe ya Biashara *",
    "Phone Number *": "Nambari ya Simu *",
    "Country / Operating Region *": "Nchi / Eneo la Shughuli *",
    "Select Applications (All 10 Modules Available)": "Chagua Moduli (Moduli Zote 10 Zipo)",
    "Outgrower Farmers Count / Acreage": "Idadi ya Wakulima / Ukubwa wa Shamba",
    "Daily Milling Capacity (TCD)": "Uwezo wa Kusaga kwa Siku (TCD)",
    "Scroll to view & select modules:": "Sogeza chini kuona na kuchagua moduli:",
    "AI Assistance & Preferences": "Usaidizi wa AI na Mapendeleo",
    "Enable Synergy AI Assistant Copilot": "Washa Msaidizi wa Synergy AI Copilot",
    "Base Currency": "Sarafu ya Msingi",
    "Deployment Mode": "Njia ya Utekelezaji",
    "Summary & Confirmation": "Muhtasari na Uthibitisho",
    "Operating Region:": "Eneo la Shughuli:",
    "Capacity / Outgrowers:": "Uwezo / Wakulima:",
    "Selected Modules:": "Moduli Zilizochaguliwa:",
    "Switch to Form Mode ✎": "Badilisha kwenda Fomu ✎",
    "Synergy AI — I can help": "Synergy AI — Naweza Kukusaidia",
    "/year": "/mwaka",
    "/month": "/mwezi",
    ...
    "Does the offline M-PESA phone number validation verify national ID names automatically once back online? This would help prevent registration typos.": "Je, uhakiki wa nambari za simu za M-PESA za bila mtandao unahakiki majina ya vitambulisho vya kitaifa kiotomatiki mara tu mtandao unaporejea? Hii ingesaidia kuzuia makosa ya kuandika unaposajili.",
    ...
    "The automatic temperature correction for refractometer Brix readings saved our lab technicians substantial calculation time during shift changes.": "Marekebisho ya kiotomatiki ya halijoto kwa masomo ya Brix ya refractometer yaliwaokoa mafundi wetu wa maabara muda mwingi wa hesabu wakati wa mabadiliko ya zamu.",
    ...
    "The multi-scale tare balancing prevented weight tampering effectively during peak crushing season. Essential read for scale engineers.": "Usawazishaji wa tare kwenye mizani mingi ulizuia uchezaji wa uzito kwa ufanisi wakati wa msimu wa kilele wa kusaga. Usomaji muhimu kwa wahandisi wa mizani.",
    ...
    "The automated M-PESA B2C disbursement reduced our farmer payment settlement turnaround from 14 days down to less than 2 hours.": "Utoaji wa kiotomatiki wa fedha kupitia M-PESA B2C ulipunguza muda wa mchakato wa malipo ya wakulima kutoka siku 14 hadi chini ya masaa 2.",
    ...
    "Step 3 is key: waiting for the SQLite queue buffer to clear before restarting saved us from ticket duplication.": "Hatua ya 3 ni muhimu: kusubiri bafa ya foleni ya SQLite isafishike kabla ya kuwasha tena kutuokoa kutokana na kurudiwa kwa tiketi.",
    ...
    "The LoRaWAN telemetry sync works remarkably well across 25km sensor radii in the sugar belt.": "Usawazishaji wa telemetry ya LoRaWAN unafanya kazi vizuri sana katika eneo la sensori la kilomita 25 katika ukanda wa sukari.",
    ...
    "The RFID pallet tagging ensures accurate stock audits across all 4 warehouse bays.": "Uwekaji wa vitambulisho vya RFID kwenye godoro unahakikisha ukaguzi sahihi wa hifadhi katika ghala zote 4.",
    ...
    "Warehouse Controller": "Msimamizi wa Ghala",
    ...
    "AgTech Systems Lead": "Kiongozi wa Mifumo ya AgTech",
    ...
    "Full Page View ↗": "Muonekano Kamili Wa Ukurasa ↗",
  ...
  // State Management
  // First-time visitors default to English ('en') if synergy_lang is not set.
  // Once chosen, language preference persists in localStorage across page navigation.
